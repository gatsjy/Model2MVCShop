...
<div class="navbar  navbar-inverse navbar-fixed-top">
	...
	<div class="container">
   	...
   	<script type="text/javascript">
		...
		$( "a:contains('판매상품배송')" ).on("click" , function() {
	 		//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
		...
		$( "a:contains('취소이력조회')" ).on("click" , function() {
	 		//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
			$(self.location).attr("href","/purchase/listCancelPurchase");
		});
