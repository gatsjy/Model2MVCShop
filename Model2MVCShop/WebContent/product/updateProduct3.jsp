		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" readonly="readonly"
					name="manuDate" value="20120514" class="ct_input_g"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
				<input type="text" name="fileName" class="ct_input_g" style="width: 200px; height: 19px"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
				<input type="text" name="prodQuantity" class="ct_input_g" style="width: 200px; height: 19px"
					maxLength="13" value="${product.prodQuantity}" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
