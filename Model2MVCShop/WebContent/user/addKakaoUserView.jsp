				...
				<tr>
					<td width="105">
						<input 	type="text" name="userId" class="ct_input_bg" 
										style="width:100px; height:19px"  maxLength="20" value="${user.userId}">
					</td>
					<td>
					</td>
				</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="userName" class="ct_input_g" 
							style="width:100px; height:19px"  maxLength="50"  value="${user.userName}"/>
		</td>
	</tr>
				...
				<tr>
					<td height="26">
						...
						<input 	type="text" name="email" class="ct_input_g" 
						 ...
						 ////////////////////////////////////////////////////////////////////////////////////////////////// -->
 						<input 	type="text" name="email" class="ct_input_g" 
										style="width:100px; height:19px" value="${user.email}"/>										
					</td>
				</tr>
			</table>
		</td>
